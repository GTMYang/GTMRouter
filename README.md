...
约定
- 必须继承 GTMRouterHeader
- 必须实现 SubGTMRouterHeaderProtocol

SubGTMRouterHeaderProtocol

```swift
public protocol SubGTMRouterHeaderProtocol {
    /// 状态变成.idle
    func toNormalState()
    /// 状态变成.refreshing
...
class TaoBaoRefreshHeader: GTMRouterHeader, SubGTMRouterHeaderProtocol {
